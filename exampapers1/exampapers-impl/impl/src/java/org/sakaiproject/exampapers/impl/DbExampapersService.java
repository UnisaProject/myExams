...
package org.sakaiproject.exampapers.impl;
...
public class DbExampapersService extends BaseExampapersService {
	/** Our log (commons). */
	private static Logger M_log = LoggerFactory.getLogger(DbExampapersService.class);
	...
	protected class DbStorage implements Storage {
		...
		public String getExampapersContent(String siteId) {
		...
		public String saveExampapersContent(String siteId, String content) {
		...
		public String revertExampapersContent(String siteId) {
